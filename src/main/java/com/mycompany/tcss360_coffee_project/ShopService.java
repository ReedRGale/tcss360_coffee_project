...
public class ShopService {
    ...
    public String getShops() {
        ...
        sb.append("<html><body><style>table, th, td "
                ...
                + "0px;border-spacing: 0px;} .navbar-default {" 
                ...
                + "color: yellowgreen;} .navbar-default .nav > li>a," 
                + ".navbar-default .nav>li>a:focus {color: #222;}"
                + ".navbar-default .nav > li.active>a:hover," 
                + ".navbar-default .nav>li.active>a:focus {" 
                + "color: yeallowgreen!important;" 
                ...
                + "class=\"navbar-header\"><!-- This button will be a responsive toggle "
                + "later--><button type=\"button\" class=\"navbar-toggle\" "
                ...
                + "<span class=\"glyphicon glyphicon-globe\"></span>COFFEE</a>"
